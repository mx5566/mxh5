...
CREATE TABLE `rms_alipay_user` (
  ...
  `alipay_public_secret` longtext,
  `alipay_appid` varchar(32) DEFAULT '',
  `alipay_bs_name` varchar(256) DEFAULT '',
  `alipay_private_secret` longtext,
...
-- ----------------------------
INSERT INTO `rms_backend_user` VALUES ('1', 'lihaitao', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '18612348765', 'lhtzbj18@126.com', '/static/upload/mongodatastruct.png');
...
CREATE TABLE `rms_game` (
  ...
  `game_name` varchar(32) NOT NULL DEFAULT '' COMMENT '游戏名字',
  `game_type` int(11) NOT NULL DEFAULT '1' COMMENT '类型：例如传奇类型或者等等',
  `game_icov` bigint(20) NOT NULL DEFAULT '0' COMMENT 'icov的id',
  `game_per_num` bigint(20) NOT NULL DEFAULT '0' COMMENT '下载用户数目',
  `game_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '游戏状态',
  `game_weight` int(11) NOT NULL DEFAULT '0' COMMENT '权重',
  `backend_user_id` int(11) NOT NULL COMMENT '那个用户',
  `game_icov_str` varchar(255) DEFAULT '' COMMENT 'icov地址',
  `game_description` varchar(1024) DEFAULT '' COMMENT '描述',
  PRIMARY KEY (`game_id`),
...
INSERT INTO `rms_game_tab_rel` VALUES ('23', '4', '6');
INSERT INTO `rms_game_tab_rel` VALUES ('24', '3', '6');
...
CREATE TABLE `rms_game_type` (
  ...
  `game_type_name` varchar(16) NOT NULL DEFAULT '' COMMENT '类传奇',
  `game_type_weight` tinyint(4) NOT NULL DEFAULT '0' COMMENT '权重',
  `game_type_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'status',
...
CREATE TABLE `rms_image` (
  ...
  `image_name_md5` varchar(32) NOT NULL DEFAULT '',
  `image_info` varchar(100) NOT NULL DEFAULT '',
  `backend_user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `rms_nav` (
  ...
  `nav_name` varchar(16) NOT NULL DEFAULT '' COMMENT '导航名',
  `nav_weight` tinyint(4) NOT NULL DEFAULT '0' COMMENT '权重',
  `nav_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'status',
  PRIMARY KEY (`nav_id`)
...
CREATE TABLE `rms_notice` (
  ...
  `notice_title` varchar(128) NOT NULL DEFAULT '' COMMENT '公告标题',
  `notice_content` longtext NOT NULL COMMENT '公告内容',
  `notice_weight` tinyint(4) NOT NULL DEFAULT '0' COMMENT '权重',
  `notice_status` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'status',
...
INSERT INTO `rms_role_backenduser_rel` VALUES ('69', '22', '1', '2019-09-02 22:44:40');
...
CREATE TABLE `rms_role_resource_rel` (
  ...
  `created` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1567 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `rms_tab` (
  ...
  `tab_weight` tinyint(4) NOT NULL DEFAULT '0',
  `tab_status` tinyint(4) NOT NULL DEFAULT '0',
  `tab_type_id` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`tab_id`)
...
CREATE TABLE `rms_tab_type` (
  `tab_type_id` tinyint(4) NOT NULL,
  `tab_type_name` varchar(255) NOT NULL DEFAULT '' COMMENT '分类类型的明细',
  `tab_type_weight` tinyint(4) NOT NULL DEFAULT '0',
  `tab_type_status` tinyint(4) NOT NULL DEFAULT '0',
...
-- Records of ss
-- ----------------------------
INSERT INTO `ss` VALUES ('1', '12', '12');
INSERT INTO `ss` VALUES ('2', '13', '10');
INSERT INTO `ss` VALUES ('3', '40', '45');
INSERT INTO `ss` VALUES ('4', '12', '9');
